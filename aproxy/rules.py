...
COMMON_TASKS = [
    ...
    },
    {
        "name": "kxdaili.com",
        "resource": [
            "http://ip.kxdaili.com/ipList/{}.html".format(i) for i in range(1, 11)
        ],
        "enable": 1,
    },
    {
        "name": "ip3366.net",
        "resource": [
            "http://www.ip3366.net/free/?stype=1&page=%s" % i for i in range(1, 3)
        ]
    ...
    {"name": "us-proxy.org", "resource": ["https://www.us-proxy.org/"], "enable": 1,},
    {
        "name": "sslproxies.org/",
